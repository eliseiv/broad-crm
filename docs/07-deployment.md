...
- **Обязательных новых env нет:** `BACKEND_USERS_SNAPSHOT_INTERVAL_SEC` и `BACKEND_USERS_SNAPSHOT_REVENUE_BATCH` имеют рабочие дефолты (`900` / `2000`); прод-`.env` править не обязано.
