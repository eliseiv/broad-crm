...
| `name` | string | 1–255 |
| `content_md` | string \| null | только у документа и только в `GET /nodes/{id}` (в списках/дереве не отдаётся) |
...
**Response 200** — обновлённый `DocumentNode`. **Ошибки:** `401`, `403`, `404 document_node_not_found`, `409 document_node_conflict`, `400/422 validation_error`.
